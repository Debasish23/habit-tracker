...
export class Backend implements backendInterface {
    ...
    async createHabit(arg0: string, arg1: Date_): Promise<HabitId> {
        if (this.processError) {
            try {
    ...
    async getHabit(arg0: HabitId): Promise<HabitView> {
        if (this.processError) {
            try {
    ...
    async getHabits(): Promise<Array<[HabitId, HabitView]>> {
        if (this.processError) {
            try {
    ...
    async markComplete(arg0: HabitId, arg1: Date_): Promise<void> {
        if (this.processError) {
            try {
    ...
    async unmarkComplete(arg0: HabitId, arg1: Date_): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.unmarkComplete(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
